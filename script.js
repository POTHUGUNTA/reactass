    ...
    787: function (e, n, t) {
      ...
      var i,
        ...
        f = function (e, n) {
          ...
          addEventListener ('visibilitychange', t, !0), addEventListener (
            'pagehide',
            t,
            !0
          );
        ...
        m = function (e, n, t) {
          ...
          return function (r) {
            n.value >= 0 &&
              (r || t) &&
              ((n.delta = n.value - (i || 0)), (n.delta || void 0 === i) &&
                ((i = n.value), e (n)));
          };
        },
        v = -1,
          ...
          var t,
            ...
            a = function (e) {
              'first-contentful-paint' === e.name &&
                (f && f.disconnect (), e.startTime < i.firstHiddenTime &&
            ...
            f = o ? null : c ('paint', a);
          (o || f) &&
            ((t = m (e, r, n)), o && a (o), s (function (i) {
              (r = u (
                'FCP'
              )), (t = m (e, r, n)), requestAnimationFrame (function () {
            ...
            v = function (e) {
              if (!e.hadRecentInput) {
                ...
                a &&
                  ...
                  ? ((a += e.value), o.push (e))
                  : ((a = e.value), (o = [e])), a > r.value &&
                  ((r.value = a), (r.entries = o), t ());
              }
            },
            p = c ('layout-shift', v);
          p &&
            ((t = m (i, r, n)), f (function () {
          ...
          if (e.cancelable) {
            ...
            'pointerdown' == e.type
              ? (function (e, n) {
                  ...
                  addEventListener ('pointerup', t, E), addEventListener (
                    'pointercancel',
                    i,
                    E
                  );
        ...
        C = function (e, n) {
          var t,
            ...
            p = function (e) {
              e.startTime < a.firstHiddenTime &&
                ((v.value = e.processingStart - e.startTime), v.entries.push (
                  e
                ), t (!0));
            },
            d = c ('first-input', p);
          (t = m (e, v, n)), d &&
            ...
            s (function () {
              ...
              (v = u (
                'FID'
              )), (t = m (e, v, n)), (o = []), (r = -1), (i = null), F (addEventListener), (a = p), o.push (a), S ();
            });
        },
        k = {},
        P = function (e, n) {
          ...
          if (o) {
            ...
            var v = function () {
              k[r.id] ||
                (o.takeRecords ().map (a), o.disconnect (), (k[r.id] = !0), t (
                  !0
                ));
            };
            ['keydown', 'click'].forEach (function (e) {
              ...
              (r = u (
                ...
                requestAnimationFrame (function () {
                  (r.value =
                    performance.now () - i.timeStamp), (k[r.id] = !0), t (!0);
                });
              });
            });
          }
        ...
        D = function (e) {
          ...
          (n = function () {
            try {
              ...
              if (
                ((t.value = t.delta = n.responseStart), t.value < 0 ||
                  t.value > performance.now ())
              )
                return;
              (t.entries = [n]), e (t);
            } catch (e) {}
